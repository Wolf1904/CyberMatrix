...
st.set_page_config(page_title="LibLupusArctos", page_icon="🖥️", layout="wide")
...
st.write("###")
st.write("###")
st.info("*The Study Material Provided Is Not Ours And Belongs To Respective Owners.*", icon="ℹ️")
